/* empty css                                     */
import { d as createAstro, c as createComponent, m as maybeRenderHead, b as addAttribute, r as renderTemplate, a as renderComponent, e as renderScript, f as renderSlot, g as defineScriptVars, u as unescapeHTML } from '../../chunks/astro/server_DwqtjhkU.mjs';
import 'kleur/colors';
import 'clsx';
import { $ as $$Layout } from '../../chunks/Layout_D9HZCX9x.mjs';
/* empty css                                     */
import { a as getNotionPosts, b as getNotionPost, g as getNotionContentVersion } from '../../chunks/notion_BPuEf98Q.mjs';
...
Selanjutnya <i class="i-myna-chevron-double-right"></i> </span> <span>${nextPost.title}</span> </a>`} </div> </div> </div> ` }), defineScriptVars({ initialVersion: contentVersion ?? null }));
